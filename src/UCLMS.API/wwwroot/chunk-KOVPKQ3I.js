...
var VERSION = /* @__PURE__ */ new Version("20.3.21");
...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
  const tAttributes = rootSelectorOrNode ? ["ng-version", "20.3.21"] : (
...
var ApiService = class _ApiService {
  ...
  get(path, params) {
    ...
    return this.http.get(`${API_BASE}/${path}`, { params: httpParams }).pipe(map((r) => r.data));
  }
  getPaged(path, params) {
    return this.get(path, params);
  }
  post(path, body) {
    return this.http.post(`${API_BASE}/${path}`, body).pipe(map((r) => r.data));
  }
  put(path, body) {
    return this.http.put(`${API_BASE}/${path}`, body).pipe(map((r) => r.data));
  }
  patch(path, body) {
    return this.http.patch(`${API_BASE}/${path}`, body ?? {}).pipe(map((r) => r.data));
  }
  delete(path) {
    return this.http.delete(`${API_BASE}/${path}`).pipe(map(() => void 0));
  }
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-KOVPKQ3I.js.map
