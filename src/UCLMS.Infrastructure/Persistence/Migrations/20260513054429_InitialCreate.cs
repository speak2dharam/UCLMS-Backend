        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObservesAllOrganizations = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    InvitationToken = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TemplateFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CertificateTemplates_Users_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObserverOrgAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObserverOrgAssignments_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObserverOrgAssignments_Users_ObserverUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgCourseEnrollments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrgCourseEnrollments_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrgCourseEnrollments_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrgCourseEnrollments_Users_EnrolledById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Certificates_CertificateId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseEnrollments_Users_EnrolledByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizAttempts_Users_GradedByUserId",
                        column: x => x.GradedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsEarned = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CertificateTemplates_CreatedById",
                table: "CertificateTemplates",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_CourseEnrollments_CertificateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseEnrollments_EnrolledByUserId",
                table: "CourseEnrollments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObserverOrgAssignments_ObserverUserId_OrganizationId",
                table: "ObserverOrgAssignments",
                columns: new[] { "ObserverUserId", "OrganizationId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ObserverOrgAssignments_OrganizationId",
                table: "ObserverOrgAssignments",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_OrgCourseEnrollments_CourseId",
                table: "OrgCourseEnrollments",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_OrgCourseEnrollments_EnrolledById",
                table: "OrgCourseEnrollments",
                column: "EnrolledById");

            migrationBuilder.CreateIndex(
                name: "IX_OrgCourseEnrollments_OrganizationId",
                table: "OrgCourseEnrollments",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_GradedByUserId",
                table: "QuizAttempts",
                column: "GradedByUserId");
